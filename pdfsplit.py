...
def split_file(filename):
    command="pdftk.exe " + filename + " burst output " + OUTPUT_PATH  + "%05d.pdf"
    exec_command(command)
    return dest
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", dest="input_filename", default="2016a.pdf",
                      help="write merged PDF to FILE", metavar="FILE")
    parser.add_argument("-o", "--output", dest="output_path", default="./cut/",
                      help="write merged PDF to FILE", metavar="FILE")
